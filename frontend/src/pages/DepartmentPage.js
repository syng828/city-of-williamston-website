  ...
  const departments = {
    department1: {
      ...
      content: (
        <>
          <h2>Department 1</h2>
          <p>This is the content for Department 1.</p>
        </>
      ),
    },
    department2: {
      ...
      content: (
        <>
          <h2>Department 2</h2>
          <p>This is the content for Department 2.</p>
        </>
      ),
    },
    department3: {
      ...
      content: (
        <>
          <h2>Department 3</h2>
          <p>This is the content for Department 3.</p>
        </>
      ),
    },
    department4: {
      ...
      content: (
        <>
          <h2>Department 4</h2>
          <p>This is the content for Department 4.</p>
        </>
      ),
    },
  };
